...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
	<div class="container-fluid">
		<a class="navbar-brand" href="#"><i
			class="fa-regular fa-money-bill-1"></i> Budget Buddy</a>
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty loginUser }">
					...
					<li class="nav-item"><a class="nav-link active"
						href="index.jsp"><i class="fa-solid fa-house"></i>
							Home</a></li>
				...
				<c:if test="${not empty loginUser }">
					<li class="nav-item"><a class="nav-link active"
						href="user/home.jsp"><i class="fa-solid fa-house"></i>
							Home</a></li>
					...
					<li class="nav-item"><a class="nav-link active"
						href="view_expense.jsp" tabindex="-1"><i
							class="fa-solid fa-table-list"></i> View Expense</a></li>
